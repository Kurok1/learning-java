...
import indi.kurok1.rpcfx.api.ServiceProviderDesc;
import indi.kurok1.rpcfx.demo.api.OrderService;
import indi.kurok1.rpcfx.demo.api.UserService;
import indi.kurok1.rpcfx.server.RpcfxInvoker;
...
//		registerService(client, orderService);
	...
	@Bean(name = "indi.kurok1.rpcfx.demo.api.UserService")
	public UserService createUserService(){
		return new UserServiceImpl();
	}

	@Bean(name = "indi.kurok1.rpcfx.demo.api.OrderService")

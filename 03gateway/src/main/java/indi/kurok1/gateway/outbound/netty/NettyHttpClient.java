...
public class NettyHttpClient extends HttpClient {
    ...
    public NettyHttpClient() {
        this.serializer = ServiceUtils.defaultImplement(Serializer.class, null);
        this.deserializer = ServiceUtils.defaultImplement(Deserializer.class, new DefaultDeserializer());
    }
...
//                    ch.pipeline().addLast(new HttpRequestEncoder());
                    ...
                    ch.pipeline().addLast(new HttpClientHandler(request, serializer, deserializer));
                }
            });
